...
//			$('#ts').val("");
	 ...
	 * @private
	 */
	function getImageBase64(file) {getImageBase64
	...
	function investorformSubmit(){
			...
			var photosrc3 = '';
			if($('#ts').val() == '1'){
				if($('#backImg1').attr('src') != '' && $('#backImg1').attr('src') != null && $('#backImg1').attr('src') != undefined && $('#backImg1').attr('src') != 'undefined'){
